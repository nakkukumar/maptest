...
--
-- Table structure for table `indianStatesLatLong`
--

CREATE TABLE IF NOT EXISTS `indianStatesLatLong` (
...
--
-- Dumping data for table `indianStatesLatLong`
--

INSERT INTO `indianStatesLatLong` (`city_id`, `city_name`, `latitude`, `longitude`, `state`) VALUES
